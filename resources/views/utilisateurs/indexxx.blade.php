...
flex items-center justify-center text-white font-bold">
                        ...
                        <td class="p-4 text-center space-x-2">
                            ...
                            <button
                                onclick="openEditModal('{{ $user->id }}','{{ $user->name }}','{{ $user->login }}','{{ $user->email }}','{{ $user->type }}')"
    ...
    <div id="createModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50">
        ...
        <div class="bg-white w-full max-w-lg p-6 rounded-2xl">
            ...
            <form method="POST" action="{{ route('parametre.utilisateurs.store') }}">
                ...
                <!-- Nom : première lettre de chaque mot en majuscule, pas d'espaces multiples -->
       ...
       ">
                ...
                <!-- Login : première lettre en majuscule, pas d'espaces multiples -->
       ...
       ">
                ...
                <!-- Email : tout en minuscules et pas d'espaces -->
       ...
       ">
                ...
                <select name="type" class="w-full border rounded-xl p-2 mb-4">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="button" onclick="closeCreateModal()" class="bg-gray-200 px-4 py-2 rounded-xl">
                        Annuler
                    </button>
    ...
    <div id="editModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50">
        ...
        <div class="bg-white w-full max-w-lg p-6 rounded-2xl">
            ...
            <form id="editForm" method="POST">
                ...
                <select id="edit_type" name="type" class="w-full border rounded-xl p-2 mb-4">
                    <option value="admin">Administrateur</option>
                    <option value="manager">Manager</option>
                    <option value="user">Utilisateur</option>
                </select>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="button" onclick="closeEditModal()" class="bg-gray-200 px-4 py-2 rounded-xl">
                        Annuler
                    </button>
    ...
    <script>
        ...
        function openEditModal(id, name, login, email, type) {
            ...
            document.getElementById('edit_type').value = type || "user";
