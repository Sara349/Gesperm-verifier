...
@section('content')
                ...
                @forelse($villes as $ville)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-4 text-center space-x-2">
                            ...
                            <button onclick="editVille('{{ $ville->id_ville }}','{{ $ville->nom_ville }}')"
                            ...
                            <button onclick="openDeleteModal('{{ $ville->id_ville }}')"
    ...
    <div id="villeModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50">
        ...
        <div class="bg-white w-full max-w-lg p-6 rounded-2xl">
            ...
            <form id="villeForm" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <label class="block mb-1">Nom de la ville</label>

                    <input type="text" name="nom_ville" id="nom_ville" class="w-full border rounded-xl p-2" required
    ...
    <script>
        function openModal() {
            ...
            document.getElementById('villeForm').action =
                "{{ route('parametre.villes.store') }}";
        ...
        function editVille(id, nom) {

            document.getElementById('villeForm').action =
                "{{ url('/parametres/villes') }}/" + id;
        ...
        function showModal() {
            ...
            let modal = document.getElementById('villeModal');
